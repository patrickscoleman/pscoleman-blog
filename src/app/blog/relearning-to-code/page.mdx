...
export const title = "On Relearning to Code as an Adult";
export const description =
  "A first-person report from a 30-something (re)learning to code after years of false starts. Plus some of the things that helped me along the way.";
export const date = "2023-02-24";
export const previewImage = "/images/mara/mara_230224.jpg";
export const alt = "Mara the dog, eating pinecone";
...
<figure align="center">
  <Image
    src="/images/blog/computer_sailboat.png"
    className="mx-auto"
...
- Then learn [Next.js](https://nextjs.org/).
...
- [Next.js](https://nextjs.org/learn/foundations/about-nextjs) (serverless framework) (**highly recommend this tutorial**)
...
<figure align="center">
  <Image
    src="/images/blog/dory_keep_swimming.gif"
    className="mx-auto"
