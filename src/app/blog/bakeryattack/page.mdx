...
export const title = "The Bakery Attack Take 2 by Haruki Murakami";
export const description =
  "Translation of Haruki Murakami's The Second Bakery Attack, a Japanese short story published in 1985.";
export const date = "2024-05-03";
export const previewImage = "/images/blog/bakery_attack.jpeg";
export const alt =
  "Illustration of a masked couple robbing a McDonalds in Japan";
...
<span className="muted italic">
  ...
  <time dateTime={date}>May 3rd, 2024</time>
</span>

<span className="muted italic">Originally published August, 1985</span>
...
- Translation tools:
  - [translatefiction.com](https://www.translatefiction.com/) ([built with the OpenAI API](/posts/translatefiction))
