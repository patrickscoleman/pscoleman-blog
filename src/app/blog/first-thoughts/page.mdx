...
previewImage: "/images/mara/mara_221219.jpeg"
hidden: true
---
...
export const title = "First Thoughts";
export const description =
  "Patrick's first blog post, in which he decides to write a blog.";
export const date = "2022-12-19";
export const previewImage = "/images/mara/mara_221219.jpeg";
export const alt = "Mara the dog, reposing on couch";
