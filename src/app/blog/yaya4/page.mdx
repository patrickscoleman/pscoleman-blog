...
date: "2024-03-18"
description: "Tools: key tools (ChatGPT, Next.js, Firebase) and basics for beginners"
previewImage: "/images/blog/yaya/preview.png"
hidden: false
---
...
export const description =
  "Tools: key tools (ChatGPT, Next.js, Firebase) and basics for beginners";
...
[Next.js](https://nextjs.org/) is a great framework for building React web apps that comes with a lot of built-in features that make development much easier. It's also great for SEO and performance (see [SSR/SSG](https://vercel.com/blog/nextjs-server-side-rendering-vs-static-generation), etc.). It was created by Vercel, so works best when you deploy there (more below).

### Vercel

We used [Vercel](https://vercel.com/) to host the app. It's a great platform for hosting Next.js apps (and other serverless apps). It's easy to use, has great performance (see their [Edge Network](https://vercel.com/docs/edge-network/overview), etc.), and is free for small projects. Deploying is as easy as [pushing to Github](https://vercel.com/docs/deployments/git/vercel-for-github) and the [basic analytics](https://vercel.com/docs/analytics) are solid too.
...
As I mentioned in the first post, I'm currently looking for my next gig. I'm especially intested in AI, edtech, or dev tools startups. If you need a smart, hard-working business generalist with a technical background, [consider hiring me](/hireme).
