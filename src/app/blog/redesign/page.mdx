...
title: "Site Redesign"
date: "2024-05-14"
description: "A minimalistic retromodern redesign, plus a move to Next.js 14."
...
export const description =
  "A minimalistic retromodern redesign, plus a move to Next.js 14.";
...
I redesigned my site to have a minimalistic retro computing (but still kinda modern) look. For the UI, I used [v0 by Vercel](https://v0.dev/), [shadcn/ui](https://ui.shadcn.com/), and [Lucide](https://lucide.dev/guide/packages/lucide-react). I also moved from Next.js 13 to [Next.js 14](https://nextjs.org/blog/next-14).
