...
Yaya is a generative-AI language learning app that lets you learn another language by reading fun dialogs, stories, and articles on any topic. In Yaya's first 6 months, I helped with frontend coding (React, Next.js, Tailwind, TypeScript, etc.), user research, and product design. I switched to an advisory role when I started traveling in July 2023. Read more about [what I learned from Yaya](/posts/yaya).
