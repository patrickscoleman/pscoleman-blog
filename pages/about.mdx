...
<small>
  Updated: <time dateTime={date}>February 22nd, 2023</time>
</small>
...
### [Yaya Press](https://www.yaya.press/)

**Co-Founder**

Yaya is a generative-AI language learning app that lets you learn another language by reading fun dialogs, stories, and articles on any topic. I've done a mix of growth/marketing, product design, frontend coding (React, Next.js, Tailwind, TypeScript, etc.), and user research.
