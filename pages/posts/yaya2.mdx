...
- **Immersion:** Some very serious learners want complete immersion in their target language. It was possible to use Yaya without translations but that wasn't our emphasis. These people are also likely to graduate off of learning tools within 6 months to a couple years, which could limit customer lifetime value (LTV) unless we reengaged them to come back and learn another new language.
