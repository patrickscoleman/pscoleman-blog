...
**v2.0**: I stepped away from Yaya last summer (to travel the world), but David's continued building Yaya since then. He just released a massive update. The new version focuses on students working with language tutors. It's got a ton of features for language learners and tutors to use together during sessions and individually to study or prep. [Check out Yaya v2.0](https://www.yaya.press/)!
