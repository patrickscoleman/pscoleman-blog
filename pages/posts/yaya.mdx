...
I stepped away from Yaya last summer for two major reasons. I wanted to travel the world with my new wife. And after some reflection, I realized that I enjoyed working on the business side of startups (go-to-market, growth, and ops) more than I enjoyed spending my days coding. David wanted to keep Yaya small, so it didn't make sense to do that for Yaya.
...
- Most people interested in learning a language haven't started yet or are beginners. We really struggled to make the "newbie" reading level on Yaya easy enough for beginners. And what easy means varies somewhat from language to language. Getting this right turned out to be more work than we initially expected.
- These days everyone (whether you've used it or not) knows of [Duolingo.](https://www.duolingo.com/) Their users love the gamified quizzes and clear progression. We didn't spend enough time specifically differentiating ourselves vs. them. And we didn't do a good job making users feel like they were learning and progressing.
- Most language learners want to speak and communicate in a foreign language, not read literature, news, etc. It's harder to get people to try a new hobby than it is to get them to try a new product.
- Chat is the dominant interface metaphor in AI right now. Some people were confused by how Yaya used AI (and even thought that we wrote the stories ourselves). People also wanted to customize the content after the initial generation, which we didn't allow. (This level of customization did make it into David's v2.0)
- Many people (especially the younger generations ("ok boomer...")) prefer video to text, largely hanging out on TikTok and YouTube. We could market there, but it's tough to get users off platform.
- Learners have an expectation that their learning content will be correct. It varied a lot by language, but the AI-generated content included occasional grammatical mistakes and awkward phrasing. Beginners (who we struggled to reach) wouldn't know, but more experienced learners (who we thought we were targeting) would be turned off.
- Serious learners typically use flashcards with spaced-repetition to supplement other tools (check out the [Fluent Forever book](https://fluent-forever.com/book) for great [Anki](https://apps.ankiweb.net/) tips). We thought SRS vocabulary in the context of a story would be more fun/effective. We didn't communicate that well enough to know if it resonated.
- Most people are casual learners, looking to spend say just 15-minutes a day studying. This further limited our audience and meant we'd have to find serious learners where they hung out (e.g. [subreddits](https://www.reddit.com/r/LearnJapanese/), [forums](https://japanese.stackexchange.com/), etc.). These communities are typically averse to self-promotion.
...
As we learned more, our niche kept growing smaller and smaller. And for Yaya v1.0, we didn't find product-market fit.

I also think that before overbuilding, we could have spent more of our time getting feedback from the market (while being careful not to give people [faster horses](https://hbr.org/2011/08/henry-ford-never-said-the-fast)). Instead I was spending a lot of my time coding unused features ([see above](#get-clarity)) and creatively procrastinating ([see below](#prioritize)). There are only so many hours in the day and it's easy to fall into these traps, so it's good to specialize. I think that's why the best teams include a mix of product builders (engineers, designers, PMs, etc.) and business growers (sales, marketing, ops, etc.).
...
(Note to beginners: Don't let all that discourage you from getting started. The payoff is great and the journey is fun, whether you code professionally or not. Plus there's more help available than ever. Considering using [Replit](https://replit.com/) and [freeCodeCamp](https://www.freecodecamp.org/). They've got great learning resources and great communities. Disclaimer: I used to work at Replit. Stick to it but have patience!)
