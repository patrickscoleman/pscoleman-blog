...
There's lots of comprehensible and compelling content out there from books to TV, movies, music, and games, but we decided to take a stab at making reading great foreign language content easier. We figured we could do better (or at least more engaging) than the many [graded readers](https://en.wikipedia.org/wiki/Graded_reader) out there. And we decided to offer it in any language, so we could reach as many people as possible.
...
If you spend any time in Silicon Valley circles, you'll hear a lot about "hypergrowth" and moving fast ([see above even](#darlings) :P) and you'll see people achieve astronomical financial success in a short amount of time (and sometimes lose it just as fast). While moving fast is great practical advice for building a certain type of business (but definitely not all), some things just take time.

Learning is one of these things. This is not [the Matrix](https://www.youtube.com/watch?v=OrzgxUhnYjY). The human brain and body take time to acquire new skills. It's well enough known in the tech world that you'll often hear the phrase: "humans grow linearly, companies grow exponentially" (source: [Khalid Halim](https://review.firstround.com/hypergrowth-and-the-law-of-startup-physics/)). And even all these wonderful AI assist tools are still limited by biology.

At some level, I internalized the learn-to-code-in-X-time rhetoric and the techie-exceptionalism, and I figured that within a few months I'd be able to code a fully-featured and compelling product entirely on my own. I was wrong.

But not completely wrong though. I _was_ able to do this _in collaboration_ with a partner. And I did get better and better every day every day that I sat down and wrote code and debugged.

People dedicate their lives and careers to this thing. Why not [learn programming in 10 years](https://norvig.com/21-days.html) instead? Why not [get to the bottom of things](https://www-cs-faculty.stanford.edu/~knuth/email.html) instead of trying to stay on top of everything?
...
And of course, having fun is just as applicable for language learning as it is for startups!
