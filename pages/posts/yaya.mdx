...
corrolary to give users what they want, but beware users that want a faster horse
...
In short: Focus on what's life or death for your startup (or project). In the very beginning, that's typically all product.
...
For a talented writer's take on all this, check out [Jennifer Egan's](https://jenniferegan.com/) latest novel, Candy House. In it she parodies generated stories built with standardized ["stockblocks"](https://theconversation.com/in-the-candy-house-jennifer-egan-delivers-an-inventive-novel-for-a-digital-age-181151) to great comedic and storytelling effect (among many other ideas and threads).
