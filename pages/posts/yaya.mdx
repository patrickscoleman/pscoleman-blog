...
During the first half of 2023, I, [Patrick Coleman](/about) (a startup business guy), and my friend, [David Gaynor](http://freedavid.co/) (an experienced engineer/founder), built the first version of Yaya. It used AI to generate reading content at an appropriate learning level in (almost) any language. We built it using ChatGPT, NextJS, and Firebase.

David also taught me how to code.
...
On March 15th, David released a massive update/overhual of Yaya. The new version focuses on students working with language tutors. It's got a ton of features for language learners and tutors to use together during sessions and individually to study or prep.

Needless to say, we're very optimistic about the new version. [Give it a go!](https://www.yaya.press/)

## This series

Here's what to expect over the next few weeks. I'll be adding links to the posts as they go live.

- **Part 1** (this post): An introduction to Yaya v1.0
- **Part 2** (coming 3/25): A deeper dive on the lessons learned while building Yaya
- **Part 3** (coming 4/1): The backstory: how I got to Yaya, what I did, and our early iterations
- **Part 4** (coming 4/8): The tools we used to build Yaya and some final thoughts
...
As for me, I'm looking for work again doing startup go-to-market, growth, and ops ([send me an email](mailto:patrick@pscoleman.me) if you'd like to chat). That's what I like and where I believe I can do my best work.

I stepped away from Yaya last summer for two major reasons.

First, I realized that I enjoy working on the business side of startups more than I enjoy spending my days coding. David wants to keep Yaya small, so it doesn't make sense to do that for Yaya.

And second, I wanted to travel the world with my wife. This meant pausing professional work and drawing down savings. David wants to bootstrap Yaya. Now that I'm back, I need a steady salary again. As you may know, life in San Francisco is expensive. But I love it here, it's close to family, and I can't imagine living anywhere else.
...
Thank you too for reading this first post. I hope to see you back each week as I share more.
...
This one's long so here's a ToC (feel free to jump around):
...
I also think that before overbuilding, we could have spent more of our time getting feedback from the market (while being careful not to give people [faster horses](https://hbr.org/2011/08/henry-ford-never-said-the-fast)). Instead I was spending a lot of my time personally coding unused features ([see above](#be-clear-on-what-you-want)) and creatively procrastinating ([see below](#ruthlessly-prioritize-your-time)). There are only so many hours in the day and it's easy to fall into these traps, so it's good to specialize. I think that's why the best teams include a mix of product builders (engineers, designers, PMs, etc.) and business growers (sales, marketing, ops, etc.).
...
The most important thing when building a new software product is to **move fast**. This is especially true if you're smaller than your competition. I've learned this time and again in my [startup career](/about#professional-highlights). So think about what's critically important for your users, build that and only that, ship it, and get feedback. If it doesn't work, kill it. If it does, improve it and/or move on.
...
Thanks for reading! I'll be back next week with the backstory of Yaya. Here are all the posts in the series. I'll be adding links as they go live.
...
**description: The backstory: how I got to Yaya, what I did, and our early iterations.**

<small>
  <time dateTime={date}>April 1st, 2024</time>
</small>

News update: This morning, we got an unsolicited 7-figure acquisition offer for Yaya from a huge public tech co! April fools ;)

Welcome back again! If you're just joining us now, I recommend [starting at the beginning](/posts/yaya). In this post, I'll share some of the history of [Yaya](https://www.yaya.press) and my work contributions. Read on.

- [Prologue](#prologue) (my skippable personal backstory)
- [What I worked on](#what-i-worked-on) (my share of things)
...
The seeds for Yaya were planted a long time ago. Let's briefly go back to the very beginning.
...
Thanks for reading! I'll be back next week with the final post, an overview of our tools. I'll add a link when it goes live. Here is a list of the whole series.
...
Welcome back for the final post in the series! Once again if you're new, [start at part 1](/posts/yaya).
...
Note: there's a new version of Yaya too. [Check it out!](https://www.yaya.press/)
...
Foreign language learning is a big passion of mine. I've studied Spanish (español), Japanese (日本語), and Korean (한국어). I also love software. Using it, writing it, and helping grow it. It was a treat to work on a project that combined these interests. I learned so so much.
...
I think I can offer the most to early-/mid-stage startups working on AI, edtech or dev tools. But I'm open to anything with an inspiring team and mission. If you'd like to chat, please [email me.](mailto:patrick@pscoleman.me)
