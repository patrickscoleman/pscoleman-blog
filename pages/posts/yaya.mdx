...
(Note: People are not just trying to learn a language, but they're also trying to stay motivated while they learn (check out [this blogpost](https://www.reachcapital.com/2023/06/15/product-lessons-from-duolingos-former-chief-product-officer-jorge-mazal/) from the former CPO at Duolingo).)
