...
If you're using Windows now and don't have a good professional reason for that, switch. Mac has a great ecosystem for developers, and coding on a unix-based OS is a better experience.
