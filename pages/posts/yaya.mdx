...
Also in high school, I started taking compsci classes, placing directly into AP CS and going on to take classes in AI (things have changed a ton since 2007) and computer architecture. I got totally absorbed in coding. But I studied finance in college.

Later as my professional career shifted from Wall Street to software startups, I kept toying with the idea of finally learning to code properly. I considered taking a bootcamp or going back to school, but I didn't think it'd be the right fit. My background knowledge was all over the place, as an adult I've prefered self-directed learning, and many institutions are teaching outdated curriculum. As part of a consulting project, I looked at tech stacks of startups over the past decade and saw a big shift to [serverless architectures](https://docs.aws.amazon.com/serverless/latest/devguide/serverless-shift-mindset.html).
