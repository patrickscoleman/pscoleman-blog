...
- [What I learned](#what-i-learned) (plus some advice for other software builders)
...
Also in high school, I started taking compsci classes, placing directly into AP CS and going on to take classes in AI and computer architecture. Things have changed a lot since 2007... I got totally absorbed in coding. But then I studied finance in college.

Later as my professional career shifted from Wall Street to software startups, I kept toying with the idea of finally learning to code properly. I considered taking a bootcamp or going back to school, but I didn't think it'd be the right fit. My background knowledge was all over the place, I've prefered self-directed learning as an adult, and many institutions are teaching outdated curriculum. As part of a consulting project, I looked at tech stacks of startups over the past decade and saw a big shift to [serverless architectures](https://docs.aws.amazon.com/serverless/latest/devguide/serverless-shift-mindset.html).
...
I learned a lot building Yaya. I got a lot right and a lot wrong. I'm writing all this down to get some clarity for myself, but I'm sharing it in the hopes that it will help others working on software startups (or just software projects) too.
...
(Note to beginners: Don't let all that discourage you from getting started. The payoff is great and the journey is fun. Plus there's more help available than ever. One option is [freeCodeCamp](https://www.freecodecamp.org/). It's got great learning resources and a great community. Stick to it but have patience!)
