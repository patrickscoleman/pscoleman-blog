...
Also in high school, I started taking compsci classes, placing directly into AP CS and going on to take classes in AI (things have changed a ton since 2007) and computer architecture. I got totally absorbed in coding. Later as my professional career shifted from Wall Street finance to software startups, I kept toying with the idea of finally learning to code properly. I considered briefly taking a bootcamp or going back to school, but I didn't think it'd be the right fit. My background knowledge is all over the place, I'm a bit of an autodidact, and many formal institutions are teaching outdated (https://docs.aws.amazon.com/serverless/latest/devguide/serverless-shift-mindset.html)
