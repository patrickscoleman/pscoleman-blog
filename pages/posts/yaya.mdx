...
During the first half of 2023, I, Patrick Coleman (a startup business guy), and my friend, [David Gaynor](http://freedavid.co/) (an experienced engineer/founder), built the first version of Yaya. It used AI to generate reading content at an appropriate learning level in (almost) any language. We built it using ChatGPT, NextJS, and Firebase.
...
This one's long. Here's a ToC:

<a id="toc"></a>
### 目次

the juicy bits, plus some advice for other software builders
...
- [Part 1](/posts/yaya): An introduction to Yaya v1.0
...
Thanks for reading! If you'd like to go back and revisit anything, here's a list of the whole series.
